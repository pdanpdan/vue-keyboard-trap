...
function z(o, r, a, m) {
  r === !0 ? (delete o.dataset[m.datasetName], o.tabIndex === m.trapTabIndex && o.removeAttribute("tabindex")) : (o.dataset[m.datasetName] = Object.keys(a.modifiers).filter((c) => a.modifiers[c] === !0).join(" "), o.tabIndex < 0 && o.getAttribute("tabindex") === null && (o.tabIndex = m.trapTabIndex));
}
function O(o, r) {
  const a = W(o), m = (e, { value: T, modifiers: v }) => {
    const t = {
      disable: T === !1,
      modifiers: v,
      focusTarget: null,
      ...
      activate(n) {
        ...
        p !== e && (s === null || s.closest(a.datasetNameSelector) !== e) && (S(e, a), t.relatedFocusTarget = s, (s === null || s.dataset[a.datasetNamePreventRefocus] === void 0 || e.contains(s) === !1) && requestAnimationFrame(() => {
      ...
      deactivate(n) {
        ...
        n.__vKbdTrap = !0;
        const s = n.relatedTarget;
        p === e && (s === null || s.closest(a.datasetNameSelector) !== e) && (t.focusTarget = n.target, S(null, a));
      },
      trap(n) {
        if (t.disable === !0 || n.__vKbdTrap === !0)
          return;
        ...
        if (s === "Escape") {
          if (n.__vKbdTrap = !0, p === e) {
            if (t.focusTarget = g, t.modifiers.escexits === !0) {
        ...
        if (t.modifiers.roving === !0) {
          ...
          if (s !== "Tab" && l === !0)
            return;
          if (s === "Tab")
            l === !1 && t.modifiers.tabinside !== !0 ? (y = e.parentElement.closest(a.datasetNameSelector), y !== null && (n.__vKbdTrap = void 0), q === !0 ? (f = 1, x = (u, d) => d) : (f = -1, x = () => 0)) : f = q === !0 ? -1 : 1;
          else if (s === "Home")
            f = 1, x = (u, d) => d;
          else if (s === "End")
            f = -1, x = () => 0;
            ...
            u !== null && (y = u, n.__vKbdTrap = void 0, s === (M(g, e) === !0 ? "ArrowRight" : "ArrowLeft") || s === "ArrowUp" ? (f = 1, x = (d, A) => A) : (f = -1, x = () => 0));
          } else
            (t.modifiers.vertical === !0 || t.modifiers.horizontal !== !0) && (s === "ArrowUp" ? (f = -1, w = "v") : s === "ArrowDown" && (f = 1, w = "v")), (t.modifiers.vertical !== !0 || t.modifiers.horizontal === !0) && (s === "ArrowLeft" ? (f = -1, w = "h") : s === "ArrowRight" && (f = 1, w = "h"), f !== 0 && w === "h" && M(g, e) === !0 && (f *= -1));
        } else
          s === "Tab" && (f = q === !0 ? -1 : 1);
        if (f === 0)
          return;
        y === !1 ? n.preventDefault() : (t.focusTarget = g, t.focusTarget.dataset[a.datasetNamePreventRefocus] = "", requestAnimationFrame(() => {
        ...
        if (w !== !1) {
          ...
          if (t.modifiers.grid === !0) {
            ...
            b = Array.from(e.querySelectorAll(A)), l = new WeakMap(
              b.map((R) => {
            ...
            const u = Array.from(e.querySelectorAll('[role="row"]')), d = /* @__PURE__ */ new WeakMap(), A = u.map((L, F) => {
            ...
            b = Array.from(e.querySelectorAll(E)), l = new WeakMap(
              b.map((L) => {
        ...
        if (b.length === 0) {
          ...
          if (b = Array.from(e.querySelectorAll(l)), v.indexorder === !0) {
            const u = new WeakMap(
              b.map((d) => [d, Math.max(d.tabIndex || 0, 0)])
            );
            b.sort((d, A) => u.get(d) - u.get(A));
          }
          e.matches(l) && b.unshift(e);
        }
        const C = b.length - 1;
      ...
      refocus(n) {
        return t.disable === !1 && p === e && t.focusTarget && t.focusTarget.closest(a.datasetNameSelector) === e ? t.focusTarget.tabIndex === a.trapTabIndex ? t.modifiers.autofocus === !0 && N(e.querySelector(a.autofocusSelector)) === !0 || N(e.querySelector(a.focusableSelector)) === !0 || N(t.focusTarget) === !0 : n === !0 ? !1 : N(t.focusTarget) === !0 || N(e.querySelector(a.focusableSelector)) === !0 : !1;
      },
      autofocus() {
        requestAnimationFrame(() => {
          t.disable === !1 && N(e.querySelector(a.autofocusSelector), j) === !1 && N(e.querySelector(a.focusableSelector), j);
        });
      }
    };
    t.bind(), v.autofocus === !0 && t.autofocus();
  }, c = (e, { value: T, modifiers: v }) => {
    const t = P(e);
    if (t !== null) {
      const n = T === !1;
      t.modifiers = v, z(e, n, t, a), p === e && (n === !0 ? S(null, a) : e.dataset[a.datasetNameActive] = ""), t.disable !== n && (t.disable = n, v.autofocus === !0 ? t.autofocus() : n === !1 && p !== e && e.contains(document.activeElement) === !0 && S(e, a));
    } else
      r !== void 0 ? m(e, { value: T, modifiers: v }) : p === e && S(null, a);
  }, i = (e) => {
    const T = P(e);
    T !== null && T.unbind(), p === e && S(null, a);
  };
  return r !== void 0 ? r({
    name: a.name,
    directive: {
