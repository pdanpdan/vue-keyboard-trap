...
function D(o, r) {
  const a = W(o), m = (e, { value: v, modifiers: g }) => {
    const t = {
      disable: v === !1,
      modifiers: g,
      focusTarget: null,
      ...
      trap(s) {
        if (t.disable === !0 || s.__vKbdTrap === !0)
          return;
        const { code: n, shiftKey: w } = s, { activeElement: T } = document;
        if (n === "Escape") {
          if (s.__vKbdTrap = !0, b === e) {
            if (t.focusTarget = T, w === !0)
              s.preventDefault();
            else {
        ...
        if (t.modifiers.roving === !0) {
          ...
          if (n !== "Tab" && u === !0)
            return;
          if (n === "Tab")
            u === !1 && t.modifiers.tabinside !== !0 ? (y = e.parentElement.closest(a.datasetNameSelector), y !== null && (s.__vKbdTrap = void 0), w === !0 ? (f = 1, h = (c, d) => d) : (f = -1, h = () => 0)) : f = w === !0 ? -1 : 1;
          else if (n === "Home")
            f = 1, h = (c, d) => d;
          else if (n === "End")
            f = -1, h = () => 0;
            ...
            c !== null && (y = c, s.__vKbdTrap = void 0, n === (M(T, e) === !0 ? "ArrowRight" : "ArrowLeft") || n === "ArrowUp" ? (f = 1, h = (d, A) => A) : (f = -1, h = () => 0));
          } else
            (t.modifiers.vertical === !0 || t.modifiers.horizontal !== !0) && (n === "ArrowUp" ? (f = -1, x = "v") : n === "ArrowDown" && (f = 1, x = "v")), (t.modifiers.vertical !== !0 || t.modifiers.horizontal === !0) && (n === "ArrowLeft" ? (f = -1, x = "h") : n === "ArrowRight" && (f = 1, x = "h"), f !== 0 && x === "h" && M(T, e) === !0 && (f *= -1));
        } else n === "Tab" && (f = w === !0 ? -1 : 1);
        if (f === 0)
          return;
        y === !1 ? s.preventDefault() : (t.focusTarget = T, t.focusTarget.dataset[a.datasetNamePreventRefocus] = "", requestAnimationFrame(() => {
          ...
          if (t.modifiers.grid === !0) {
            ...
            p = Array.from(e.querySelectorAll(C)), u = new WeakMap(
              p.map((F) => {
                ...
                let k;
                return x === "v" ? K === E && (k = 1 * q) : q === _ && (k = 1 * K), [F, k];
              })
            );
          }
        ...
        if (p.length === 0) {
          ...
          if (p = Array.from(e.querySelectorAll(u)), g.indexorder === !0) {
            const c = new WeakMap(
      ...
      refocus(s) {
        if (t.disable === !1 && b === e && t.focusTarget) {
          ...
          for (; n && n !== e; ) {
            const w = P(n);
            if (w !== null && w.disable === !1 && w.focusTarget)
              return S(n, a), w.refocus(s !== void 0 ? w.modifiers.roving !== !0 : void 0);
            n = n.parentElement && n.parentElement.closest(a.datasetNameSelector);
          }
          return t.focusTarget.tabIndex === a.trapTabIndex || t.focusTarget.matches("dialog") === !0 || t.focusTarget.matches("[popover]") === !0 ? t.modifiers.autofocus === !0 && N(e.querySelector(a.autofocusSelector)) === !0 || N(e.querySelector(a.focusableSelector)) === !0 || N(t.focusTarget) === !0 : s === !0 ? !1 : N(t.focusTarget) === !0 || N(e.querySelector(a.focusableSelector)) === !0;
        }
        return !1;
      },
      autofocus() {
  ...
  }, l = (e, { value: v, modifiers: g }) => {
    const t = P(e);
    if (t !== null) {
      const s = v === !1;
      t.modifiers = g, z(e, s, t, a), b === e && (s === !0 ? S(null, a) : e.dataset[a.datasetNameActive] = ""), t.disable !== s && (t.disable = s, g.autofocus === !0 ? t.autofocus() : s === !1 && b !== e && e.contains(document.activeElement) === !0 && S(e, a));
    } else r !== void 0 ? m(e, { value: v, modifiers: g }) : b === e && S(null, a);
  }, i = (e) => {
    const v = P(e);
    v !== null && v.unbind(), b === e && (v.relatedFocusTarget && N(v.relatedFocusTarget), S(null, a));
  };
  return r !== void 0 ? r({
    name: a.name,
    directive: {
