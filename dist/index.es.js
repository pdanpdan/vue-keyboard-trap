...
function visibleFocusCheckFn(el, scrolled = false) {
...
function focus(el, checkFn = defaultFocusCheckFn) {
...
function dirIsRtl(activeElement, currentTrapEl) {
  const dirEl = (
...
export { VueKeyboardTrapDirectiveFactory, directivePlugin as VueKeyboardTrapDirectivePlugin, directivePlugin as default };
